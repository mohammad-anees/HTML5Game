...
window.addEventListener("load",function() {
	...
	Q.Sprite.extend("Food", {
		...
		if(client == 1){
			...
			socket.on('mouseUpdate3',function(data)
			{
				_x = data.mousePositionX;
				_y = data.mousePositionY;
				
				_vx = (_x/60);
				_vy = (_y/60);
				
				_angle = data.CannonAngle;
			...
			socket.on('mouseUpdate4',function(data)
			{
				_x = data.mousePositionX;
				_y = data.mousePositionY;
